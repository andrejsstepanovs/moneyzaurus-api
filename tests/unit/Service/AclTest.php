...
class AclTest extends TestCase
{
    ...
    public function allowedDataProvider()
    {
        return array(
            ...
            array(User::ROLE_GUEST, Acl::ROLE_USER, 'update', false),
            array(User::ROLE_GUEST, Acl::ROLE_USER, 'data', false),
            array(User::ROLE_GUEST, Acl::ROLE_USER, 'register', true),
            ...
            array(User::ROLE_USER, Acl::ROLE_USER, 'update', true),
            array(User::ROLE_USER, Acl::ROLE_USER, 'data', true),
            array(User::ROLE_USER, Acl::ROLE_USER, 'register', false),
            ...
            array(User::ROLE_ADMIN, Acl::ROLE_USER, 'update', true),
            array(User::ROLE_ADMIN, Acl::ROLE_USER, 'data', true),
            array(User::ROLE_ADMIN, Acl::ROLE_USER, 'register', false),
